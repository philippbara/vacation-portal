...
VALUES
('admin', 'Super', 'Admin', 'admin@example.com', crypt('adminpass', gen_salt('bf')), 'admin'),
('manager', 'Manny', 'Manager', 'manager@example.com', crypt('managerpass', gen_salt('bf')), 'manager'),
('employee1', 'Alice', 'Anderson', 'alice@example.com', crypt('employee1pass', gen_salt('bf')), 'employee'),
('employee2', 'Bob', 'Brown', 'bob@example.com', crypt('employee2pass', gen_salt('bf')), 'employee');
